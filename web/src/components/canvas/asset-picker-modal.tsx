...
import { canvasImageSourceFromAsset, type CanvasImageSource } from "@/services/canvas-image-source";
import { useAssetStore, type Asset } from "@/stores/use-asset-store";

export type InsertAssetPayload = { kind: "text"; content: string; title: string } | { kind: "image"; source: CanvasImageSource; title: string } | { kind: "video"; url: string; title: string; storageKey?: string; width?: number; height?: number };
        ...
        if (asset.kind === "text") {
            ...
            onInsert(
                asset.kind === "video"
                    ...
                    : { kind: "image", source: canvasImageSourceFromAsset(asset.data, asset.coverUrl), title: asset.title },
            );
        }
    };
